...
const DevisExpress = () => {
  ...
  return (
    <SiteLayout>
      <style>{`
        .devis-page { font-family: 'Glacial Indifference', sans-serif; background-color: #000; }
      ...
      <div className="devis-page text-white pb-20">
        <div className="max-w-[1450px] mx-auto px-6">
          ...
          <div className="mt-4 hero-banner">
            <h1 className="text-4xl font-bold uppercase leading-tight max-w-5xl">
            ...
            <button onClick={scrollToBesoins} className="btn-orange absolute top-[150px] right-12">
              Demander un devis
            </button>
          </div>

          <div className="grid grid-cols-4 gap-4 py-4 border-b border-gray-800 text-center uppercase">
          ...
          <div className="mt-4 max-w-6xl">
            <h3 className="text-lg font-bold mb-4">Pourquoi demander un devis express ?</h3>
