...
//   return (
//     <SiteLayout>
//       <div className="w-full max-w-[1780px] mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col gap-6 lg:gap-8">
        
//         {/* ================================================================= */}
//         {/* 1. BANNIÈRE PRINCIPALE CONFORME ADOBE XD (Noeuds 68, 69, 70, 71)  */}
//         {/* Dimensions maquette : 1779 x 255 px avec fond baobabs sunset      */}
//         {/* ================================================================= */}
//         <div className="relative w-full rounded-[15px] overflow-hidden min-h-[190px] sm:min-h-[220px] md:min-h-[255px] bg-[#221008] border border-white/10 flex items-center shadow-2xl">
...
//         {/* Si la BDD ne contient aucun produit, affiche l'icône épurée        */}
