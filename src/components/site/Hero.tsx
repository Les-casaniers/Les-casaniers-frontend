...
const slides = [
  {
    ...
    // titre: "Aurora Gaming",
    description: "Le meilleur pc n’est pas forcément le plus puissant du marché. C’est celui adapté à tes besoins, pour jouer et évoluer sereinement.",
    prix: "6 990 000 Ar",
    boutonTexte: "DECOUVRIR NOS UNIVERS",
  },
  {
    id: 2,
    image: slide2,
